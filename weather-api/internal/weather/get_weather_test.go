...
func TestGetWeather(t *testing.T) {
	...
	weather_repository_with_valid_json := datasource.NewWeatherRepository(mock_client_with_valid_json)
	get_weather_with_valid_json := weather.NewGetWeatherUseCase(weather_repository_with_valid_json)

	mock_client_with_invalid_json := NewMockClient("invalid")
	weather_repository_with_invalid_json := datasource.NewWeatherRepository(mock_client_with_invalid_json)
	get_weather_with_invalid_json := weather.NewGetWeatherUseCase(weather_repository_with_invalid_json)

	t.Run("valid weather", func(t *testing.T) {
		get_weather_dto := weather.WeatherInputDTO{
		...
		assert.IsType(t, &weather_output, &weather.WeatherOutputDTO{})
	})
